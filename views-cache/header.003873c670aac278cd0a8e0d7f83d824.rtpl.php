            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt"><?php echo getCartVlSub(); ?></span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo getCartNtQtd(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
